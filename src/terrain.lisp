...
(defpackage #:horde3d-terrain-cffi
  (:nicknames #:%h3d-terrain)
  (:use #:common-lisp #:cffi #:%h3d)
  (:export 
   #:add-terrain-node
...
(defcenum terrain-node-parameters
    "The available Terrain node parameters:

 :terrain-height-map-resource - Height map texture; must be square and a power of two [type: ResHandle, write-only]
 :terrain-material-resource   - Material resource used for rendering the terrain [type: ResHandle]
...
"
  (:terrain-height-map-resource 10000)
  :terrain-material-resource
  :terrain-mesh-quality
  :terrain-skirt-height
  :terrain-block-size)
