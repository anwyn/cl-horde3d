...
(defctype resource-handle :int
  "Handle to resource (int).")

(defctype node-handle :int
  "Handle to scene node (int).")
...
(defh3fun ("setResourceParamf" set-resource-paramf) :boolean
  ...
  Returns:
           true in case of success otherwise false
"
  (res resource-handle) (param :int) (value :float))
...
(defh3fun ("setResourceParamstr" set-resource-paramstr) :boolean
  ...
  Returns:
           true in case of success otherwise false
"
  (res resource-handle) (param :int) (value :string))
...
(defh3fun ("updateResourceData" update-resource-data) :boolean
 ...
 Notes on available ResourceData parameters:
  ...
  Returns:
          true in case of success, otherwise false
"
  (res resource-handle) (param :int)  (data :pointer) (size :int))
...
(defh3fun ("getNodeParamf" get-node-paramf) :float
  ...
  Returns:
           value of the parameter
"
  (node node-handle) (param node-param))
...
(defh3fun ("setNodeParamf" set-node-paramf) :boolean
  ...
  Returns:
           true in case of success otherwise false
"
  (node node-handle) (param node-param) (value :float))
...
(defh3fun ("setNodeParami" set-node-parami) :boolean
  ...
  Returns:
           true in case of success otherwise false
"
  (node node-handle) (param node-param) (value :int))
...
(defh3fun ("setNodeParamstr" set-node-paramstr) :boolean
  ...
  Returns:
           true in case of success otherwise false
"
  (node node-handle) (param node-param) (value :string))
...
"
  (start-node node-handle) (name :string) (type scene-node-type))
